...
namespace DLM.painel
{
    public class PLAN_PEP : PLAN_BASE
    {
        public string fabrica
        {
            get
            {
                if (this.PEP.LenghtStr() > 2)
                {
                    return this.PEP.Substring(this.PEP.LenghtStr() - 2, 2);
                }
                return "";
            }
        }
        ...
        public void Ler(bool carrega_id = true)
        {
            ...
            this.logistica_cronograma = Linha["logistica_cronograma"].DataNull();
            this.montagem_cronograma = Linha["montagem_cronograma"].DataNull();

            this.engenharia_cronograma_inicio = Linha["engenharia_cronograma_inicio"].DataNull();
            this.fabrica_cronograma_inicio = Linha["fabrica_cronograma_inicio"].DataNull();
            this.logistica_cronograma_inicio = Linha["logistica_cronograma_inicio"].DataNull();
            this.montagem_cronograma_inicio = Linha["montagem_cronograma_inicio"].DataNull();
